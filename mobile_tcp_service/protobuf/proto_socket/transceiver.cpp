...
class ProtoTransceiveInitializer{
        public:
                ...
                int clientTransmitter(int bytecount_client, int hsock_client);
};
...
int ProtoTransceiveInitializer::clientTransmitter(int bytecount_client, int hsock_client){
...
int ProtoTransceiveInitializer::transceiveExecuter(int hsock, int *csock,  int err, int hsock_client, int bytecount_client) {
        ...
        while (true)
        {
                ...
                client.host_port_client = 1102;
                client.host_name = (char *)"127.0.0.1"; 
                client.hsock_client = socket(AF_INET, SOCK_STREAM, 0);
                ProtoTransceiveInitializer::clientBinder(client.host_name, client.host_port_client, client.hsock_client, client.p_int_client, client.err_client);

                //CLIENT TRANSMIT
                ProtoTransceiveInitializer::clientTransmitter(client.bytecount_client, client.hsock_client);
